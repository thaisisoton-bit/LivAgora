...
| File | Purpose |
|---|---|
| `livagora-landing.html` | Public homepage |
| `search-results.html` | Search results (filters, list of hotels) |
| `hotel-page.html` | Hotel detail + mini cart |
| `cart.html` | Standalone cart review (optional step) |
...
**Not yet built:** About page, host/admin side (partner login, dashboard, inbox, reservations, inventory, finance/invoicing, host-side reviews).
